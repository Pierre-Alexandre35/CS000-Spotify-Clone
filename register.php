        ...
        <div id="login-container">
            ...
            <p>
                ...
                <div class="hasAccountCheck">
                    <a class="noAccountLink" href="#"><span class="hideLoggin">Don't Have An Account Yet? Sign Up Here</span></a>
                </div>
            </form>
            <form id="registerForm" action="register.php" method="POST">
                ...
                <div class="hasAccountCheck">
                    <a class="alreadyAccountLink" href="#"><span class="hideLoggin">Already Have An Account Yet? Sign In Here</span></a>
                </div>
            </form>
            </div>
            </div>
